package edu.njuit.xc.springbootlearn.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import edu.njuit.xc.springbootlearn.response.AjaxResponse;
import edu.njuit.xc.springbootlearn.pojo.Article;
import edu.njuit.xc.springbootlearn.pojo.Reader;
...
public class ArticleController {
    ...
    public AjaxResponse saveArticleByParams(
            ...
            @RequestParam(value = "author", defaultValue = "xc", required = false) String author,
